...
<!-- bagian Nama -->
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" value="{{$karyawan->Nama_Karyawan}}" id="Nama_Karyawan" name="Nama_Karyawan" class="form-control">
...
<!-- bagian Jabatan_____cek -->
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="jabatan_id" name="jabatan_id" class="form-control"readonly value="{{$j->jabatan_id}}"> {{$j->Nama_Jabatan}} >

                        <select name="jabatan_id" id="jabatan_id" class="form-control">
                            @foreach ($jabatan as $j)
                            <option readonly value="{{$j->jabatan_id}}"> {{$j->Nama_Jabatan}}</option>
