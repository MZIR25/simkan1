...
<!-- bagian Nama -->
            ...
            @endif
            <form action="/simpan_karyawan" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group row">
                    <label for="Nama_Karyawan" class="col-sm-2 col-form-label">Nama Karyawan</label>
                    <div class="col-sm-10">
                        <input type="text" id="Nama_Karyawan" name="Nama_Karyawan" class="form-control" placeholder="Masukkan Nama Karyawan">
...
<!-- bagian Pendidikan -->
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="Tingkat_Pendidikan" name="Tingkat_Pendidikan" class="form-control" placeholder="Masukkan Tingkat Pendidikan">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="Tahun_Lulus" name="Tahun_Lulus" class="form-control" placeholder="Masukkan Tahun Lulus">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="No_Ijazah" name="No_Ijazah" class="form-control" placeholder="Masukkan Nomor Ijazah">
...
<!-- bagian Alamat_Karyawan --> 
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="Alamat_Karyawan" name="Alamat_Karyawan" class="form-control" placeholder="Masukkan Alamat Karyawan">
...
<!-- bagian Golongan_Darah --> 
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" id="Golongan_Darah" name="Golongan_Darah" class="form-control" placeholder="Masukkan Golongan Darah">
...
<!-- bagian Jumlah_Anak --> 
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" id="Jumlah_Anak" name="Jumlah_Anak" class="form-control" placeholder="Masukkan Jumlah Anak">
...
<!-- bagian No_Hp --> 
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" id="No_Hp" name="No_Hp" class="form-control" placeholder="Masukkan No Hp">
...
<!-- bagian Mulai_Kerja --> 
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" id="Mulai_Kerja" name="Mulai_Kerja" class="form-control" placeholder="Masukkan Mulai Kerja">
